...
export default function Modal({ heading, content, button, handleCookieModal }) {
  return (
    <div className="text-[#2b2b30] modal z-10 fixed w-[400px] bg-[#B7BFFF] border border-[#ece8e86b] bottom-10 left-10 p-6 rounded-xl">
